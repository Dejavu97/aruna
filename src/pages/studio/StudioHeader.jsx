...
export default function StudioHeader({ colors,
  ...
  return (
<header className="sticky top-0 z-50 bg-paper border-b border-ink/10 px-4 lg:px-6 py-2.5 shadow-sm">
      <div className="w-full max-w-[1440px] mx-auto flex flex-wrap items-center justify-between gap-x-4 gap-y-2">
